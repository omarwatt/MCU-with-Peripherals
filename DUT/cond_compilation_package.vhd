...
--==================================================================================================================
	...
	constant G_PLL_DIV_SMCLk 			: NATURAL	:= 2;											-- relavant only when G_MODELSIM=0
	constant G_PLL_MUL_SMCLk	 		: NATURAL	:= 1;											-- relavant only when G_MODELSIM=0

	constant G_PLL_DIV_DIVCLK			: NATURAL	:= 1;											-- relavant only when G_MODELSIM=0
	constant G_PLL_MUL_DIVCLK		 	: NATURAL	:= 2;											-- relavant only when G_MODELSIM=0 									-- relavant only when G_MODELSIM=0 	
-- Explanation:
-----------------------------------------------------------
